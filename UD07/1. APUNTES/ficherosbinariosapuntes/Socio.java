...
/**
 * Clase ficherosbinariosapuntes.Socio de ejemplo para cargar objetos desde un archivo XML ("src/socio.xml")
...
public class Socio implements Serializable {
    ...
    public String toString() {
        return "ficherosbinariosapuntes.Socio [id=" + id + ", nombre=" + nombre + ", direccion=" + direccion + ", alta=" + alta + "]";
    }
