...
public class AppLaberintoV01 extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        personaje.setImagen(new Image("mapaV01aguado/img/personaje.png"));
        mapa.dibujarPersonaje(personaje);

        mapa.dibujarImagen(new Image("mapaV01aguado/img/carne.jpg"), 9, 7 );
        mapa.dibujarImagen(new Image("mapaV01aguado/img/carne.jpg"), 12, 15 );
